  ...
  return (
    <section className="relative w-full min-h-[60vh] flex flex-col justify-end bg-black">
      ...
      <div className="relative z-10 px-4 sm:px-8 py-10 md:px-20 flex flex-col gap-4 w-full max-w-5xl mx-auto">
        <p className="text-[#F97316] bg-white/10 border border-white/20 backdrop-blur-sm text-xs sm:text-sm font-semibold px-3 py-1 rounded-full w-fit mb-2">3rd Term &bull; 2025/2026 Academic Session</p>
